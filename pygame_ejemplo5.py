...
pygame.display.set_caption("Ejemplo 5")

hit_snd = pygame.mixer.Sound("hit-00.wav")
gov_snd = pygame.mixer.Sound("cartoon118.wav")
img_bck = pygame.transform.scale(pygame.image.load("canvas_by_roytanck.jpg"),(640, 480))
